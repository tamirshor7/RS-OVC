...
freeze_keywords = ['backbone.0','bert','rsfm']#['backbone.0', 'bert']      # for whole model, e.g. ['backbone.0', 'bert'] for freeze visual encoder and text encoder
lr_backbone = 1e-05                           # specific learning rate
lr_backbone_names = ['backbone.0', 'bert','rsfm']
...
box_threshold = 0.5#0.02 for text only 
text_threshold = 0.0
zs_filter_bound = 0.05
use_coco_eval = False
label_list = [
