...
from CountGD.util import box_ops, get_tokenlizer
from CountGD.util.misc import (
    NestedTensor,
    get_world_size,
    inverse_sigmoid,
...
class GroundingDINO(nn.Module):
    ...
    def __init__(
        ...
        self.feature_map_proj = nn.Conv2d(DINO_FEATURES if rs_only else SWINT_FEATURES, hidden_dim, kernel_size=1)
